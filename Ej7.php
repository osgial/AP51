...
<body>
    ...
    function buscarPalabra(string $texto, string $palabra) {
        $texto=strtoupper($texto);
        $palabra=strtoupper($palabra);
        if (str_contains($texto, $palabra)) {
            $cantidad = substr_count($texto, $palabra);
            echo "La palabra ". $palabra . " se encuentra " . $cantidad . " vez/veces en el texto<br>";
        } else {
            echo "La palabra " . $palabra . " no se encuentra en el texto.";
        }
    }
    echo buscarPalabra($texto, "Nullam")
